			...
			<div id="container" <?php cyberchimps_filter_container_class(); ?>>
				...
				<div id="content" <?php cyberchimps_filter_content_class(); ?>>
					...
					<article id="post-0" class="post error404 not-found">
					  ...
					  <?php else: ?>
								<?php _e( 'Oops! That page cannot be found.', 'cyberchimpspro' ); ?></h1>
					  <?php endif; ?>
						</header>
					...
					<?php else: ?>
								<p><?php _e( 'It looks like nothing was found at this location. Maybe try searching for it?', 'cyberchimpspro' ); ?></p>
							<?php endif; ?>
							<?php get_search_form(); ?>
