...
if ( !class_exists( 'CyberChimpsCarousel' ) ) {
	class CyberChimpsCarousel {
		...
		function cyberchimps_init_carousel_post_type() {
			register_post_type( 'featured_posts',
				array(
					'labels' => array(
						...
						'singular_name' => __( 'Posts', 'cyberchimps_elements' )
					),
					'public' => true,
					'show_ui' => true, 
			...
			$mb
				->tab( __( 'Featured Post Carousel Options', 'cyberchimps_elements' ) )
					->single_image('post_image', __( 'Featured Post Image', 'cyberchimps_elements' ), '')
					->text('post_url', __( 'Featured Post URL', 'cyberchimps_elements' ), '')
